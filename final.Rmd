...
server2 = function(input, output, session) {
  ...
  output$crimeHist = renderPlot({
    ggplot(data = dataObj()) + geom_bar(mapping = aes(fill = district, x = factor(reported_year))) + xlab('Year') + ylab('Number of Crimes Reported') + scale_fill_discrete(name = 'District')
  })
}
