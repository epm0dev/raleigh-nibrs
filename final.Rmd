...
server = function(input, output, session) {
  ...
  output$mainPlot = renderPlot({
    ggplot(data = dataObj()) + geom_bar(mapping = aes(x = reported_dayofwk, fill = district, position = 'stack')) + xlab('Day of Week of Report') + ylab('Number of Crimes Reported') + scale_fill_discrete(name = 'District')
  })
